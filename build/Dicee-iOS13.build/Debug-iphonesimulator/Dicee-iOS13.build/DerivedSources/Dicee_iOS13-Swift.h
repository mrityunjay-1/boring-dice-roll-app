...
#ifndef DICEE_IOS13_SWIFT_H
#define DICEE_IOS13_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Dicee_iOS13",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC11Dicee_iOS1311AppDelegate")
...
SWIFT_CLASS("_TtC11Dicee_iOS1313SceneDelegate")
...
SWIFT_CLASS("_TtC11Dicee_iOS1314ViewController")
@interface ViewController : UIViewController
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified dice1;
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified dice2;
- (void)viewDidLoad;
- (IBAction)rollOnButtonPress:(id _Nonnull)sender;
